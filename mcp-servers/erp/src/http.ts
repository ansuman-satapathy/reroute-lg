...
export function startErpHttpServer(port = 3001): http.Server {
  ...
  httpServer.listen(port, () => {
    console.log(`🚀 ERP MCP Server (HTTP/SSE) listening on http://localhost:${port}/sse`);
  });
